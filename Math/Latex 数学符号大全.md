...
| $\S$                 | `\S`                 | $\copyright$      | `\copyright`      | $\implies$       | `\implies`        |
| $\P$                 | `\P`                 | $\overarc{ABC}$   | `\overarc{ABC}`   | $\underarc{XYZ}$ | `\underarc{XYZ}`  |
| $\checkmark$         | `\checkmark`         | $\mathbb{R}$      | `\mathbb{R}`      | $\copyright$     | `\copyright`      |
| $\pounds$            | `\pounds`            | $\square$         | `\square`         | $\cup$           | `\cup`            |
| $\bigstar$           | `\bigstar`           | $\in$             | `\in`             | $\smiley$        | `\smiley`         |
| $\Vdash$             | `\Vdash`             | $\vDash$          | `\vDash`          | $\cancer$        | `\cancer`         |
...
| $\blacklozenge$      | `\blacklozenge`      | $\measuredangle$  | `\measuredangle`  | $\backprime$     | `\backprime`      |
| $\nexists$           | `\nexists`           | $\Finv$           | `\Finv`           | $\varnothing$    | `\varnothing`     |
| $\eth$               | `\eth`               | $\sphericalangle$ | `\sphericalangle` | $\circledR$      | `\circledR`       |
